...
def entrypoint():
    ...
    for row in range(0,tag_rows):
        for col in range(0,tag_cols):
            ...
            svg = fpdf.svg.SVGObject(make_tag_svg(id, family=args.family, svg_size=args.svg_size))
...
#             )
            ...
            paths.transform = paths.transform @ fpdf.drawing.Transform.translation(tag_origin[0], tag_origin[1])
